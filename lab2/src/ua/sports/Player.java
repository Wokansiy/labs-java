...
public class Player extends Person{
    ...
    public void setPosition(PlayerPosition p){this.position=ValidationHelper.requireNonNull(p,"pos");}
    public int getNumber(){return number;}
    public void setNumber(int n){this.number=ValidationHelper.requireInRange(n,1,99,"num");}
    public String toString(){return "Player{name='"+getFullNameProtected()+"', position="+position+", number="+number+"}";}
    public boolean equals(Object o){if(this==o)return true; if(!(o instanceof Player x))return false; if(!super.equals(o))return false;return number==x.number&&position==x.position;}
